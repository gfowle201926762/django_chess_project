...
import { game_board } from './board_classs.js'
...
chess_room_socket.onmessage = function(event){
    ...
    if (data.type == 'start_game'){
        console.log(`[RECEIVING MESSAGE TYPE=START_GAME:] ${message}`)
        channel_player.color = message
        game_board.orientation = message
        console.log(game_board.orientation)
        start_game()
        if (game_board.orientation == 'black'){
            game_board.flip_board(false)
        }
    }
...
function reorientation(message){
    console.log("INSIDE REORIENTATION")
    console.log(message)
    ...
    console.log("ENDING REORIENTATION")
...
function handle_new_game(event){
    ...
    chess_room_socket.send(JSON.stringify({
        'type': 'start',
        'message': 'let us start a new game!'
    }))
    start_game()
}
...
function handleclick(event){
    ...
    if ((turn == channel_player.color) && end_game == false){
        ...
        console.log('\n')
        console.log(turn)
        console.log(channel_player.color)
